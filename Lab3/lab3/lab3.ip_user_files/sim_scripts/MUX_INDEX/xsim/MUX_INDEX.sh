...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MUX_INDEX xil_defaultlib.MUX_INDEX xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MUX_INDEX -key {Behavioral:sim_1:Functional:MUX_INDEX} -tclbatch cmd.tcl -protoinst "protoinst_files/MUX_INDEX.protoinst" -protoinst "protoinst_files/DIV_4_REST.protoinst" -protoinst "protoinst_files/CRYPTO.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MUX_INDEX.wdb xsim.dir)
