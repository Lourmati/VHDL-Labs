...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconcat_v2_1_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LAB3_SYS xil_defaultlib.LAB3_SYS xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LAB3_SYS -key {Behavioral:sim_1:Functional:LAB3_SYS} -tclbatch cmd.tcl -protoinst "protoinst_files/MUX_INDEX.protoinst" -protoinst "protoinst_files/MUX3_1.protoinst" -protoinst "protoinst_files/LAB3_SYS.protoinst" -protoinst "protoinst_files/DIV_4_REST.protoinst" -protoinst "protoinst_files/CRYPTO.protoinst" -protoinst "protoinst_files/BIN_GRAY.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LAB3_SYS.wdb xsim.dir)
