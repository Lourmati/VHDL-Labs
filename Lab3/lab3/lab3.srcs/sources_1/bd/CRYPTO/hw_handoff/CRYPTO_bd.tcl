...
################################################################
# This is a generated script based on design: CRYPTO
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: xup_xnor2_1, and set properties
  set xup_xnor2_1 [ create_bd_cell -type ip -vlnv xilinx.com:xup:xup_xnor2:1.0 xup_xnor2_1 ]
  ...
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT0 [get_bd_pins ATAD_SPLIT_4_0/VOUT0] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_inv_0/a] [get_bd_pins xup_or3_1/a] [get_bd_pins xup_xnor2_0/b] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT1 [get_bd_pins ATAD_SPLIT_4_0/VOUT1] [get_bd_pins xup_and4_3/b] [get_bd_pins xup_inv_1/a] [get_bd_pins xup_or3_1/b] [get_bd_pins xup_or3_2/b] [get_bd_pins xup_xnor2_0/a] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT2 [get_bd_pins ATAD_SPLIT_4_0/VOUT2] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_and4_3/c] [get_bd_pins xup_inv_2/a] [get_bd_pins xup_or3_0/b] [get_bd_pins xup_or3_2/c] [get_bd_pins xup_xnor2_1/a] [get_bd_pins xup_xor2_1/a]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT3 [get_bd_pins ATAD_SPLIT_4_0/VOUT3] [get_bd_pins xup_and3_0/a] [get_bd_pins xup_inv_3/a] [get_bd_pins xup_or3_0/a] [get_bd_pins xup_xnor2_1/b] [get_bd_pins xup_xor2_1/b]
  ...
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_or2_1/a]
  connect_bd_net -net xup_and2_3_y [get_bd_pins xup_and2_3/y] [get_bd_pins xup_or2_1/b]
  connect_bd_net -net xup_and3_0_y [get_bd_pins xup_and3_0/y] [get_bd_pins xup_or2_0/b]
  connect_bd_net -net xup_and4_3_y [get_bd_pins xup_and4_3/y] [get_bd_pins xup_or2_2/b]
  connect_bd_net -net xup_and4_8_y [get_bd_pins xlconcat_0/In3] [get_bd_pins xup_and4_8/y]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and4_3/a] [get_bd_pins xup_inv_0/y] [get_bd_pins xup_or3_0/c] [get_bd_pins xup_or3_2/a]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and3_0/c] [get_bd_pins xup_inv_1/y] [get_bd_pins xup_or3_3/c]
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_inv_2/y] [get_bd_pins xup_or3_1/c] [get_bd_pins xup_or3_3/b]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and4_3/d] [get_bd_pins xup_inv_3/y] [get_bd_pins xup_or3_3/a]
  connect_bd_net -net xup_or2_0_y [get_bd_pins xlconcat_0/In0] [get_bd_pins xup_or2_0/y]
  connect_bd_net -net xup_or2_1_y [get_bd_pins xlconcat_0/In1] [get_bd_pins xup_or2_1/y]
  connect_bd_net -net xup_or2_2_y [get_bd_pins xlconcat_0/In2] [get_bd_pins xup_or2_2/y]
  connect_bd_net -net xup_or3_0_y [get_bd_pins xup_and4_8/a] [get_bd_pins xup_or3_0/y]
  connect_bd_net -net xup_or3_1_y [get_bd_pins xup_and4_8/b] [get_bd_pins xup_or3_1/y]
  connect_bd_net -net xup_or3_2_y [get_bd_pins xup_and4_8/c] [get_bd_pins xup_or3_2/y]
  connect_bd_net -net xup_or3_3_y [get_bd_pins xup_and4_8/d] [get_bd_pins xup_or3_3/y]
  connect_bd_net -net xup_xnor2_0_y [get_bd_pins xup_and2_3/a] [get_bd_pins xup_xnor2_0/y]
  connect_bd_net -net xup_xnor2_1_y [get_bd_pins xup_and2_3/b] [get_bd_pins xup_xnor2_1/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_and2_2/a] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_xor2_1/y]
