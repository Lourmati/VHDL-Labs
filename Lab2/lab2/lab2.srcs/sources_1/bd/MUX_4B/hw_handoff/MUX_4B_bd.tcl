...
################################################################
# This is a generated script based on design: MUX_4B
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT0 [get_bd_pins ATAD_SPLIT_4_0/VOUT0] [get_bd_pins xup_and2_0/a]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT1 [get_bd_pins ATAD_SPLIT_4_0/VOUT1] [get_bd_pins xup_and2_1/a]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT2 [get_bd_pins ATAD_SPLIT_4_0/VOUT2] [get_bd_pins xup_and2_2/a]
  connect_bd_net -net ATAD_SPLIT_4_0_VOUT3 [get_bd_pins ATAD_SPLIT_4_0/VOUT3] [get_bd_pins xup_and2_3/a]
  connect_bd_net -net ATAD_SPLIT_4_1_VOUT0 [get_bd_pins ATAD_SPLIT_4_1/VOUT0] [get_bd_pins xup_and2_4/a]
  connect_bd_net -net ATAD_SPLIT_4_1_VOUT1 [get_bd_pins ATAD_SPLIT_4_1/VOUT1] [get_bd_pins xup_and2_5/a]
  connect_bd_net -net ATAD_SPLIT_4_1_VOUT2 [get_bd_pins ATAD_SPLIT_4_1/VOUT2] [get_bd_pins xup_and2_7/a]
  connect_bd_net -net ATAD_SPLIT_4_1_VOUT3 [get_bd_pins ATAD_SPLIT_4_1/VOUT3] [get_bd_pins xup_and2_6/a]
  connect_bd_net -net SEL_1 [get_bd_ports SEL] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_and2_2/b] [get_bd_pins xup_and2_3/b] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net a_1 [get_bd_ports a] [get_bd_pins ATAD_SPLIT_4_1/VIN]
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins ATAD_SPLIT_4_0/VIN]
  ...
  connect_bd_net -net xup_and2_3_y [get_bd_pins xup_and2_3/y] [get_bd_pins xup_or2_3/a]
  connect_bd_net -net xup_and2_4_y [get_bd_pins xup_and2_4/y] [get_bd_pins xup_or2_0/b]
  connect_bd_net -net xup_and2_5_y [get_bd_pins xup_and2_5/y] [get_bd_pins xup_or2_1/b]
  connect_bd_net -net xup_and2_6_y [get_bd_pins xup_and2_6/y] [get_bd_pins xup_or2_3/b]
  connect_bd_net -net xup_and2_7_y [get_bd_pins xup_and2_7/y] [get_bd_pins xup_or2_2/b]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_4/b] [get_bd_pins xup_and2_5/b] [get_bd_pins xup_and2_6/b] [get_bd_pins xup_and2_7/b] [get_bd_pins xup_inv_0/y]
  ...
  connect_bd_net -net xup_or2_3_y [get_bd_pins xlconcat_0/In3] [get_bd_pins xup_or2_3/y]
