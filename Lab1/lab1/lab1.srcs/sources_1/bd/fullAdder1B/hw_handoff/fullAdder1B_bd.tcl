...
################################################################
# This is a generated script based on design: fullAdder1B
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_1 [get_bd_ports a] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_2/b] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net cin_1 [get_bd_ports cin] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_or3_0/b]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_or3_0/a]
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_or3_0/c]
  connect_bd_net -net xup_or3_0_y [get_bd_ports cout] [get_bd_pins xup_or3_0/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_xor2_0/y] [get_bd_pins xup_xor2_1/a]
